...
| M5 | Full Validation, Deterministic Replay, and OT | M1, M3, M4 | `In Progress` | Codex (TS) | 15, 23, 27 | Preflight 2026-09-04: M4 complete; M3 still in progress, so M5 public gates are not yet runnable end-to-end. | Implement the pure validated-repository boundary, known-version selection, ready scheduler, replay/OT/conflict engine, and dense unit/property coverage; integrate with available repository consumers while preserving the M3 dependency blocker in the final handoff. |
