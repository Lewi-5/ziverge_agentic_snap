...
| --- | --- | --- | --- | --- | --- | --- | --- |
| M1 | Foundations, Clock Algebra, CLI Shell, and Init | — | `Not Started` | Unassigned | 01, 02 | Not run | TypeScript scaffold is present. |
| M2 | Configuration and Identity | M1 | `Not Started` | Unassigned | Internal configuration/identity gate | Not run | Scenario 03 invokes commit and closes in M3. |
...
- Integrate the shared content algebra into working-tree and historical diff.
...
- Load remote repositories with exactly one GET of the supplied URL, no redirects,
  status 200 requirement, response bounds, and the shared repository validator.
