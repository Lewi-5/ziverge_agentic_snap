 ...
 */
export const GRAMMAR_ERROR = domainError("validation", "invalid command or arguments");
/**
 * Usage diagnostic for malformed diff command forms (SPEC §7.6, Scenario 24).
 */
export const DIFF_USAGE_ERROR = domainError("validation", "usage: snap diff [<old> <new> [--repo <repository>]]");
/**
 * Creates an invalid port error diagnostic (SPEC §7.10, Scenario 14).
 */
export function invalidPortError(operand) {
