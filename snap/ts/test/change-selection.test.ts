...
import { selectAuthoredChanges, type FileTree } from "../src/domain/tree/change.js";

const bytes = (text: string): Uint8Array => new TextEncoder().encode(text);
const tree = (entries: readonly (readonly [string, Uint8Array])[]): FileTree => new Map(entries);
